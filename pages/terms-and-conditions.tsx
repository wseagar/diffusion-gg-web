      ...
      <div className="page">
        ...
        <div className="content">
          ...
          <p className="summary">
            ...
            diffusion.gg (“diffusion.gg”) (sometimes referred to as “we”,
            “us” or “our”) and you, with respect to your use of <a className="normal" href="https://diffusion.gg">https://diffusion.gg</a> and all websites, applications and
            communications that post a link to this agreement (collectively, the
            “Site”)(“Terms and Conditions”). We reserve our right to change
            these Terms and Conditions in the future. Except as explicitly
            stated otherwise, your continued use of the Site will constitute
          ...
          <p>
            ...
            are not owned, managed or controlled by us. You expressly
            acknowledge and agree that we are not responsible for the content of
            those third party websites. You are encouraged to read that third
            party’s terms and conditions, privacy policy and any other document
            that governs your relationship with that third party.
            <br />
          </p>
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                ...
                or disrupt any parts of the Site
              </li>
              <li>
            ...
            <p>
              ...
              updates to our Site (“Enhancements”). These Enhancements may be
              made to improve our Site to you or to comply with relevant legal
              requirements.
              <br />
              <br />
              (c) We will use reasonable endeavors to notify you of any
              scheduled disruptions to our Site, including those due to any
              Enhancements. However, regardless of whether a disruption is
              scheduled or not, we are not liable to you or any third party for
              any loss or damage caused by any disruption to our Site.
              <br />
            </p>
          </p>
          ...
          <p>
            ...
            that the original content on the Site, and the software, features
            and functionality comprising the Site are the exclusive property of
            diffusion.gg (the “Materials”) and its licensors.
            <br />
            <br />
          ...
          <p>
            (a) Except as expressly provided by law, we shall not be liable to
            you or any third parties for any loss, damage, expenses or any other
          ...
          <p>
            ...
            <br />
            <br />
            (c) Where these Terms and Conditions are terminated in accordance
            with these Terms and Conditions, they will terminate without
            prejudice to any rights either party may have had against the other
            prior to termination. Further, all provisions of which by their
          ...
          <h3>Assignment</h3>
          <p>
            (a) These Terms and Conditions will bind and inure for the benefit
            of the parties, including their respective successors, permitted
          ...
          <p>
            ...
            diffusion.gg&apos;s Privacy Policy, which can be found
            here:&nbsp;
            <a className="normal" href="privacy-policy">Privacy Policy.</a>
            <br />
            <br />
            (b) You agree that we may use your information (including disclosure
            to third parties) in accordance with the terms of our Privacy
            Policy.
          </p>
          <h3>Non-Waiver</h3>
          <p>
          ...
          <p>
            ...
            jurisdiction of the courts of N/A with respect to any claim or
