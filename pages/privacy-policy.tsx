    ...
    <>
      <div className="page">
        ...
        <div className="content">
          ...
          <p className="summary">
            This privacy policy sets out how diffusion.gg
            (“diffusion.gg”) collects, processes and uses your Personal
            Information through your use of our Services.
          </p>
          <h3>Definitions</h3>
          <p>
            <strong>Anonymized Data</strong> means anonymous information
            collected by us through your use of this Website or our Services for
            statistical and/or demographic purposes. Anonymized Data may be
            ...
            <br />
            <br />
            <strong>DPO</strong> means Data Protection Officer, and is the
            person specifically appointed by us to deal with your enquiries with
            respect to this privacy policy and your Personal Information.
            <br />
            <br />
            ...
            <br />
            <br />
            <strong>Services</strong> means all services provided by
            diffusion.gg to you, including (but not limited to) this Website
            and the following: Delivery of product and service.
            <br />
            <br />
            <strong>Website</strong> means diffusion.gg and all websites,
            applications and communications that post a link to this Privacy
            Policy.
            <br />
          </p>
          ...
          <p>
            ...
            to provide you with the Services. We collect Personal Information
            for the Website to provide you with a better online experience.
            <br />
          ...
          <p>
            ...
            obligations. To determine this retention period, we take into
            account
            <br />
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                <strong>Restrictions: </strong>Subject to certain conditions,
                you may request that we restrict the processing of data we hold
                on you.
              </li>
              <li>
          ...
          <p>
            We engage Data Processors to assist us in providing you with
            Services. Data Processors are contractually obligated to us, and
            must:
            <br />
            <ul>
              <li>
                comply with, and act only on, our instructions with respect to
                the data that they process on our behalf (we, of course, give
                our instructions in accordance with this privacy policy);
              </li>
              <li>
              ...
              <li>
                first obtain our consent prior to sub-contracting data
                processing services;
              </li>
              <li>
          ...
          <h3>Social Media</h3>
          <p>
            You may choose to engage with our Services through a variety of
            social media sites and platforms, for example Facebook, Instagram
            and Twitter. When you interact with our Services through these
            social media platforms, you may allow us to receive Personal
            Information and other Anonymized Data on how you are interacting
            with our Services. This will depend on your privacy settings on each
            ...
            subject to the terms of this privacy policy. Depending on your
            social media site’s privacy settings, your Personal Information may
            become public to a community of users if you choose to engage with
            our Services through these platforms.
            <br />
            For further information on how you can customize your privacy
            settings on social media sites and how those sites handle your
            privacy, please refer to the privacy policy of each particular
            social media site.
            <br />
          </p>
          <h3>Minors</h3>
          <p>
            ...
            parent&apos;s verifiable authorization to access our Services, we
            will take steps to remove that information from our servers.
            <br />
          </p>
          <h3>Third Party Links</h3>
          <p>
            Our website contains links to other third-party websites not owned
            or managed by diffusion.gg. This privacy policy applies to this
            website only. If you click a link to a third-party website, the
            privacy policy of that website will apply. We highly recommend that
            you read the privacy policies of other websites as they may be
            different from ours.
            <br />
          </p>
          <h3>Updates</h3>
          <p>
            ...
            ensure that they meet best practices. This policy was last updated
            on December 1, 2021.
            <br />
          </p>
          <h3>Contact Us</h3>
          <p>
            ...
            please contact us at <a className="normal" href="mailto:info@diffusion.gg">info@diffusion.gg</a>.
            <br />
          </p>
          <h3>Complaints</h3>
          <p>
            If you believe that we have breached our obligations to you under
            this privacy policy or relevant privacy laws, please contact us at <a className="normal" href="mailto:info@diffusion.gg">info@diffusion.gg</a>.
            <br />
